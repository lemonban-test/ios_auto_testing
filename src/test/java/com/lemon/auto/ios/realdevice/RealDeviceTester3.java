...
用的是付费的开发者账号，找开发人员去要
com.lemonban.UICatalog:是付费开发者账号用的bundleid
com.lemonban.UICatalog2：是个人免费账号用的bundleid
 * @author happy
 *
 */
public class RealDeviceTester3 {
	public static void main(String[] args) throws Exception {
		...
		desiredCapabilities.setCapability("bundleId", "com.lemonban.UICatalog");// app文件的路径
